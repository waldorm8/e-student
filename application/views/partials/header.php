...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/styles/material.components.ext.min.css">
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/styles/style_news.css">
    <style>
    #view-source {
      position: fixed;
      display: block;
    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      <header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
        <div class="mdl-layout__header-row">
          <span class="mdl-layout-title"><?php echo $this -> session -> userdata('page'); ?></span>
