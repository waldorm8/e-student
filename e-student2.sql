...
--
-- Host: 127.0.0.1
-- Czas generowania: 15 Mar 2018, 15:59
...
INSERT INTO `recruitment_conclusion` (`id_rc`, `rc_polish_degree`, `rc_math_degree`, `rc_english_degree`, `rc_st_additional`, `rc_polish_score`, `rc_math_score`, `rc_english_score`, `rc_add_score`, `rc_behavior`, `st_id`, `sw_id`) VALUES
(0, 3, 3, 3, 3, 30, 30, 30, 0, 6, 12, 4);
